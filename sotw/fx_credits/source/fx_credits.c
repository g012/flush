...
static void fadepal(u16 *dest, const u16 *pal, u16 lv, u16 start, u16 stop) {
    int i;
...
__attribute__ ((noreturn)) int main(void) {
    ...
    u32 t = 0;
    // s16 tx=0,ty=0,tz=-400,rx=0x1300,ry=0x0,rz=0x400;
    // s16 tx=0,ty=0,tz=-400,rx=0x1300,ry=0x300,rz=0x100;
    // s16 tx=0,ty=0,tz=-400,rx=0x1300,ry=0x0,rz=0x400;
    // s16 tx=0,ty=0,tz=-400,rx=0x1300,ry=0x0,rz=0x400;
    // s16 tx=0,ty=0,tz=-400,rx=0x1300,ry=0x0,rz=0x400;
    // s16 tx=0,ty=0,tz=-400,rx=0x1300,ry=0x0,rz=0x400;
